      ...
      <section className="bg-gradient-to-br from-orange-600 to-orange-800 text-white py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-orange-100 max-w-3xl mx-auto leading-relaxed">
            Have questions about WorkforceFlow? We're here to help you succeed. 
            ...
            <div className="lg:col-span-1">
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">support@workforceflow.com</p>
                      <p className="text-gray-600">partnerships@workforceflow.com</p>
                    </div>
                  </div>
              ...
              <div className="bg-white rounded-2xl shadow-xl p-8 border border-gray-100 mt-8">
                ...
                <div className="space-y-4">
                  <Link to="/help-center" className="block p-4 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors">
                    <h4 className="font-semibold text-gray-900">Help Center</h4>
                    <p className="text-sm text-gray-600">Browse our knowledge base</p>
                  </Link>
                  <Link to="/status" className="block p-4 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors">
                    <h4 className="font-semibold text-gray-900">System Status</h4>
                    <p className="text-sm text-gray-600">Check platform status</p>
                  </Link>
                  <Link to="/terms-of-service" className="block p-4 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors">
                    <h4 className="font-semibold text-gray-900">Terms & Policies</h4>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="flex justify-end">
                    <button
                      ...
                      className="bg-gradient-to-r from-orange-600 to-orange-700 hover:from-orange-700 hover:to-orange-800 text-white font-semibold py-3 px-8 rounded-lg transition-all duration-300 transform hover:scale-105 shadow-lg disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none"
                    >
                      {isSubmitting ? (
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">Support Information</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="text-center p-6 bg-gray-50 rounded-xl">
              ...
              <p className="text-gray-600">Available for urgent issues during business hours</p>
            </div>
          </div>
        </div>
      </section>
