      ...
      const mockProjects = [
        {
          ...
          priority: "high",
          description:
            "Building a modern e-commerce platform with React and Node.js. Features include user authentication, payment processing, and inventory management.",
        },
        {
          id: 2,
          ...
          priority: "medium",
          description:
            "Designed a complete mobile app interface for a fitness tracking application with modern UI components and user-friendly navigation.",
        },
        {
          id: 3,
          ...
          priority: "low",
          description:
            "Setting up a professional WordPress blog with custom theme, SEO optimization, and content management system.",
        },
      ];
          ...
          <div className="max-w-7xl mx-auto space-y-8">
                    ...
                    <div className="flex items-center gap-4 mb-4">
                      ...
                      <div>
                        ...
                        <p className="text-orange-100 text-lg opacity-90">
                          Ready to take on new challenges and grow your
                          freelance business?
                        </p>
                      </div>
                    </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              {stats.map((stat, index) => (
                ...
                >
                  <div
                    className={`absolute inset-0 bg-gradient-to-br ${stat.bgGradient} opacity-0 group-hover:opacity-5 transition-opacity duration-500`}
                  ></div>

                  <div className="relative">
                    <div className="flex items-center justify-between mb-6">
                      <div
                        className={`p-4 rounded-2xl bg-gradient-to-br ${stat.bgGradient} shadow-lg`}
                      >
                    ...
                    {filteredProjects.length === 0 ? (
                      <div className="text-center py-16">
                        ...
                        <p className="text-gray-500 mb-8">
                          Start browsing available projects to begin your
                          freelance journey.
                        </p>
                        <button
                          onClick={() => navigate("/freelancer/projects")}
