...
const FreelancerDashboard = () => {
    ...
    if (user) {
      ...
      const mockProjects = [
        ...
        },
        {
          ...
          priority: "medium",
          description:
            "Designed a mobile app interface for a fitness tracking application.",
        },
      ];
  ...
  return (
    <PageWrapper
      title="Dashboard"
      subtitle={`Welcome back, ${user?.firstName || "Freelancer"}!`}
    >
              ...
              <div className="p-3 bg-green-100 rounded-lg">
                ...
                >
                  <path
                    ...
                    strokeLinejoin="round"
                    strokeWidth={2}
                    d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M12 8V7"
                  />
                </svg>
              </div>
            </div>
