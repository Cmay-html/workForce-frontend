            ...
            <div className="px-4 py-6 sm:px-0">
              <div className="mb-8">
                ...
                <p className="text-gray-600">
                  Welcome back, {user?.firstName}! Here's your freelance
                  business overview.
                </p>
              </div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <div className="bg-white shadow overflow-hidden sm:rounded-lg border border-gray-200">
                  <div className="px-4 py-5 sm:px-6 border-b border-gray-200">
                    ...
                    <p className="mt-1 max-w-2xl text-sm text-gray-500">
                      Latest updates on your projects and proposals
                    </p>
                  </div>
                            ...
                            <div className="flex-1">
                              <p className="text-sm text-gray-800">
                                {activity.type === "proposal_accepted" && (
                                  <>
                                    Your proposal for{" "}
                                    <strong>{activity.project}</strong> was
                                    accepted by {activity.client}
                                  </>
                                )}
                                ...
                                {activity.type === "new_message" && (
                                  <>
                                    New message from {activity.client} regarding{" "}
                ...
                <div className="bg-white shadow overflow-hidden sm:rounded-lg border border-gray-200">
                  <div className="px-4 py-5 sm:px-6 border-b border-gray-200">
                    ...
                    <p className="mt-1 max-w-2xl text-sm text-gray-500">
                      Common tasks to boost your freelance business
                    </p>
                  </div>
