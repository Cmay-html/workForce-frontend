            ...
            <div className="relative overflow-hidden bg-gradient-to-r from-orange-600 via-orange-700 to-red-600 rounded-3xl shadow-2xl">
              ...
              <div className="relative p-8 lg:p-12">
                <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-8">
                  <div>
                    <h1 className="text-4xl font-bold text-white mb-4">Active Projects</h1>
                  ...
                  <div className="flex gap-4">
                    <button
                      ...
                      className="bg-white text-orange-600 hover:bg-orange-50 px-6 py-3 rounded-xl font-semibold transition-all duration-300"
                    >
                      Find More Projects
                    </button>
                  </div>
