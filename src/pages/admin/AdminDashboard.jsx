      ...
      <div className="w-80 min-h-screen p-6 bg-dark-blue-800 shadow-xl sticky top-0 overflow-y-auto">
        ...
        <div className="flex space-x-4 mb-6">
          <button
            ...
            className="py-2 px-4 bg-red-700 text-white rounded hover:bg-red-600"
          >
            Logout
          </button>
          <a
            href="/admin/analytics"
            className="py-2 px-4 text-orange-400 hover:text-orange-300"
          >
            Analytics
          </a>
        </div>
          ...
          <form onSubmit={handleCreateOrUpdate} className="space-y-4">
            <div>
              ...
              <input
                ...
                required
                className="w-full p-2 rounded bg-dark-blue-600 text-white border border-orange-500"
              />
            </div>
            <div>
            ...
            <div>
              ...
              <input
                ...
                placeholder={
                  selectedUser ? "New password (optional)" : "Required"
                }
                onChange={(e) =>
            ...
            <div className="space-x-2 flex">
              <button
                type="submit"
                className="flex-1 py-2 bg-orange-500 text-dark-blue-900 font-bold rounded hover:bg-orange-400"
              >
        ...
        <div className="bg-dark-blue-700 p-4 rounded-lg shadow-lg">
          ...
          <form onSubmit={handleResolveDispute} className="space-y-4">
            ...
            <button
              type="submit"
              className="w-full py-2 bg-orange-500 text-dark-blue-900 font-bold rounded hover:bg-orange-400"
            >
              Resolve
            </button>
          </form>
        ...
        <div className="bg-dark-blue-800 p-6 rounded-lg shadow-lg mb-6">
            ...
            <table className="min-w-full table-auto">
              <thead>
                <tr className="bg-dark-blue-700">
                  ...
                  <th className="px-4 py-2 text-left text-orange-300">
                    Created At
                  </th>
                  <th className="px-4 py-2 text-left text-orange-300">
                    Actions
                    ...
                    <tr key={user.id} className="border-b border-dark-blue-700">
                      ...
                      <td className="px-4 py-3">
                        <button
                          ...
                          className="mr-2 py-1 px-3 bg-blue-700 text-white rounded hover:bg-blue-600"
                        >
                          Edit
                        </button>
                        <button
                          onClick={() => handleDelete(user.id)}
                          className="py-1 px-3 bg-red-700 text-white rounded hover:bg-red-600"
                        >
                          Delete
                        </button>
                      </td>
          ...
          <div className="mt-4 flex justify-center space-x-2">
            <button
              ...
              className="px-4 py-2 bg-dark-blue-700 rounded disabled:opacity-50"
            >
              Previous
            </button>
              ...
              <tbody>
                {disputes && disputes.length > 0 ? (
                  disputes.map((dispute) => (
                    <tr
                      key={dispute.id}
                      className="border-b border-dark-blue-700"
                    >
                      ...
                      <td className="px-4 py-3">
                        <button
                          onClick={() => setDisputeId(dispute.id)}
                          className="py-1 px-3 bg-yellow-600 text-white rounded hover:bg-yellow-500"
                        >
                          Resolve
                        </button>
                      </td>
